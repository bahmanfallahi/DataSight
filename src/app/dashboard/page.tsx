              ...
              <div className="flex items-center gap-2">
                <SidebarTrigger />
                 <Link href="/" className="flex items-center gap-2">
                    ...
                    <h1 className="text-2xl font-bold tracking-tight hidden sm:inline-block">DataSight</h1>
                 </Link>
              </div>
              ...
              {!parsedData && !isLoading && (
                <div className="flex flex-col items-center justify-center text-center py-16">
                  ...
                  <p className="max-w-2xl text-lg text-muted-foreground mb-8">
                    Upload a CSV or Excel file to automatically profile columns, visualize distributions, and analyze trends with AI. Or load a previously saved report from the sidebar.
                  </p>
                  <FileUploader />
                </div>
              )}
